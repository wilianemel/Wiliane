...
export interface Venue {
  ...
  menuUrl?: string;
  /** Site oficial do estabelecimento, quando cadastrado. Já existe como coluna/campo editável no painel; exibido no perfil público para gerar o clique rastreado como website_click. */
  websiteUrl?: string;
...
export const venues: Venue[] = [
  {
    ...
    atmospheres: ["casual", "descolado", "nostalgico"],
    musicStyles: [],
    openNow: false,
    isDemo: false,
    dataConfidence: 80,
  ...
  },
  {
    ...
    companions: ["casal"],
    atmospheres: ["romantico", "sofisticado", "intimista"],
  ...
  },
  {
    ...
    companions: ["casal", "amigos", "turistas"],
    atmospheres: ["sofisticado", "animado", "romantico", "badalado"],
  ...
  },
  {
    ...
    companions: ["sozinho", "casal", "familia", "amigos", "pets", "criancas"],
    atmospheres: ["tranquilo", "casual", "familiar", "aconchegante"],
    musicStyles: ["ambiente"],
    openNow: true,
    dataConfidence: 92,
  ...
  },
  {
    ...
    companions: ["familia", "amigos", "criancas", "terceira-idade"],
  ...
  },
  {
    ...
    companions: ["amigos", "casal"],
    atmospheres: ["animado", "casual", "badalado"],
    musicStyles: ["rock"],
    openNow: true,
    dataConfidence: 85,
